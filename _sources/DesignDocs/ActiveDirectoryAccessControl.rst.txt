...
-  `​RFE:Add a new option
   ad\_access\_filter <https://fedorahosted.org/sssd/ticket/2082>`__
-  `​RFE:Change the default of
   ldap\_access\_order <https://fedorahosted.org/sssd/ticket/1975>`__
-  `​issues when combining the AD provider and
   ldap\_access\_filter <https://fedorahosted.org/sssd/ticket/1977>`__

Somewhat related:

-  `​Document the best practices for AD access
   control <https://fedorahosted.org/sssd/ticket/2083>`__
