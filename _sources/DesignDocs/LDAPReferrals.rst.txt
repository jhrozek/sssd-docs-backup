...
#. 
   ...
   #. `LDAP Referrals <#LDAPReferrals>`__

      #. `Pre-requisites <#Pre-requisites>`__

         #. `sdap\_id\_op enhancements <#sdap_id_openhancements>`__

      #. `Single-entry lookup <#Single-entrylookup>`__
      #. `Multiple-entry lookup <#Multiple-entrylookup>`__
      #. `Optimizations <#Optimizations>`__
      #. `Relationship to multiple search
         bases <#Relationshiptomultiplesearchbases>`__
      #. `Questions needing research <#Questionsneedingresearch>`__
      #. `Stuff to Test <#StufftoTest>`__
...
#. Add idle disconnection timer for connections (see Ticket
   `#1036 <https://fedorahosted.org/sssd/ticket/1036>`__, needs to have
...
`#960 <https://fedorahosted.org/sssd/ticket/960>`__.
...
`#960 <https://fedorahosted.org/sssd/ticket/960>`__ should do its
