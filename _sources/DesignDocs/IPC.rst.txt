...
`​src/sbus <http://git.fedorahosted.org/cgit/sssd.git/tree/src/sbus>`__
subdirectory. In particular, the wrappers and tevent integration can be
found in
`​sssd\_dbus\_common.c <http://git.fedorahosted.org/cgit/sssd.git/tree/src/sbus/sssd_dbus_common.c>`__
and
`​sssd\_dbus\_connection.c <http://git.fedorahosted.org/cgit/sssd.git/tree/src/sbus/sssd_dbus_connection.c>`__
...
#. The monitor - Both the responders and the Data providers establish
   ...
   methods is in
   `​src/monitor/monitor\_interfaces.h <http://git.fedorahosted.org/cgit/sssd.git/tree/src/monitor/monitor_interfaces.h#n41>`__
