...
George
`McCollister? <https://docs.pagure.org/sssd-test2/McCollister.html>`__
(1):
...
-  sdap\_add\_incomplete\_groups(): fix ret may be uninitialized warning
...
-  nss\_group: Cache the result from sssd when the glibc provided buffer
   is too small.
...
-  sss\_idmap: fix typo which prevents sub auth larger then 2\ :sup:`31`
