...
-  Support for LDAP referrals
   ...
   -  This is only supported on platforms running openldap libraries >=
      2.4.13
...
-  Fix `#382 <https://fedorahosted.org/sssd/ticket/382>`__, a segfault
   bug in the memberof plugin.
...
-  Fix for `#344 <https://fedorahosted.org/sssd/ticket/344>`__
