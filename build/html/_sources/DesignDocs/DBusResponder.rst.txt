...
#. `DBus responder design <#DBusresponderdesign>`__

   #. `Problem Statement <#ProblemStatement>`__
   #. `The DBus interface design <#TheDBusinterfacedesign>`__

      #. `Cached objects <#Cachedobjects>`__
      #. `Object exposed on the bus <#Objectexposedonthebus>`__
      #. `Representing users and groups on the
         bus <#Representingusersandgroupsonthebus>`__
      #. `Representing SSSD processes on the
         bus <#RepresentingSSSDprocessesonthebus>`__
      #. `Representing service objects on the
         bus <#Representingserviceobjectsonthebus>`__
      #. `Representing domain objects on the
         bus <#Representingdomainobjectsonthebus>`__
      #. `Synchronous getter behaviour <#Synchronousgetterbehaviour>`__

   #. `SSSD daemon features <#SSSDdaemonfeatures>`__

      #. `Access control <#Accesscontrol>`__

         #. `Limiting access to the
            responder <#Limitingaccesstotheresponder>`__
         #. `Limiting access to
            attributes <#Limitingaccesstoattributes>`__

      #. `Support for non-POSIX users and
         groups <#Supportfornon-POSIXusersandgroups>`__
      #. `Do not require enumeration to be enabled to retrieve set of
         users <#Donotrequireenumerationtobeenabledtoretrievesetofusers>`__
...
-  `​Provide an experimental DBus responder to retrieve custom
   ...
   cache <https://fedorahosted.org/sssd/ticket/2072>`__
-  `​Extend the LDAP backend to retrieve extended set of
   attributes <https://fedorahosted.org/sssd/ticket/2073>`__
...
Objects <https://docs.pagure.org/sssd-test2/DesignDocs/DBusCachedObjects.html>`__
...
Groups <https://docs.pagure.org/sssd-test2/DesignDocs/DBusUsersAndGroups.html>`__
