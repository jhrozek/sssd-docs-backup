...
-  `​https://fedorahosted.org/sssd/ticket/2370 <https://fedorahosted.org/sssd/ticket/2370>`__
...
`#2243 <https://fedorahosted.org/sssd/ticket/2243>`__).
...
`InfoPipe? <https://docs.pagure.org/sssd-test2/InfoPipe.html>`__. During
feature design review, it was suggested that a configuration interface
doesn't belong to the
`InfoPipe? <https://docs.pagure.org/sssd-test2/InfoPipe.html>`__ code at
...
tracked by
`​https://fedorahosted.org/sssd/ticket/2395 <https://fedorahosted.org/sssd/ticket/2395>`__
...
-  Tracked by:
   `​https://fedorahosted.org/sssd/ticket/2500 <https://fedorahosted.org/sssd/ticket/2500>`__
...
-  Tracked by:
   `​https://fedorahosted.org/sssd/ticket/2504 <https://fedorahosted.org/sssd/ticket/2504>`__
...
sooner. There are even some proof-of-concept patches `​on
sssd-devel <https://lists.fedorahosted.org/pipermail/sssd-devel/2014-November/022403.html>`__

-  Tracked by:
   `​https://fedorahosted.org/sssd/ticket/2503 <https://fedorahosted.org/sssd/ticket/2503>`__
...
-  Tracked by:
   `​https://fedorahosted.org/sssd/ticket/2482 <https://fedorahosted.org/sssd/ticket/2482>`__
...
-  Tracked by:
   `​https://fedorahosted.org/sssd/ticket/2502 <https://fedorahosted.org/sssd/ticket/2502>`__
