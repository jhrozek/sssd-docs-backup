...
-  `​RFE Integrate SSSD with CIFS
   client <https://fedorahosted.org/sssd/ticket/1534>`__
...
-  `​Integrate SSSD with CIFS
   Client <https://docs.pagure.org/sssd-test2/DesignDocs/IntegrateSSSDWithCIFSClient.html>`__
-  `​Global Catalog Lookups in
   SSSD <https://docs.pagure.org/sssd-test2/DesignDocs/GlobalCatalogLookups.html>`__
...
`#1559 <https://fedorahosted.org/sssd/ticket/1559>`__. But getting a SID
for a user or a group would be at least hard and ugly if not impossible.
I think the solution proposed in ticket
`#1559 <https://fedorahosted.org/sssd/ticket/1559>`__ is a good and
