...
-  Each KVP of the config file is described with the section in the
   ...
   property2 = value2 property3 = value3 property4 = value4

    In real schema file the properties will be taken from a predefined
    set of properties described later on this page.
...
-  Schema definitions allows implications – this means that there are
   ...
   be described in more details later on the page.
-  Schema will be extensible. This means that it can be split between
   ...
   way. The rules of compliance will be defined later on this page.

Catalog of the KVP properties
-----------------------------
...
-  **special** – the following syntax of the value will be used: key =
   ...
   -  **[...]** - optional section, if present should contain a list of
...
-  Preparation
   ...
   -  Add support for additional data types into conversion functions -
   ...
   -  Add support for sting lists with explicitly quoted elements -
      ...
      `#449 <https://fedorahosted.org/sssd/ticket/449>`__
...
-  Validate grammar itself
   ...
   -  For each KVP definition :
      ...
      -  Check:
         ...
         -  Referenced properties are defined and they are not this same
            property (avoid reflexive references)
...
-  Validate
   ...
   -  For each key in each section of the config file
      ...
      -  Check that value matches all defined properties (details TBD)
      -  Report error on failure
