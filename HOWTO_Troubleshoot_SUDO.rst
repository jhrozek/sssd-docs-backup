...
#. Run *sudo*
#. File */var/log/sudo\_debug* contains sudo logs
...
#. Restart SSSD
#. Run sudo
#. Log files are stored in */var/log/sssd/sssd\_$NAME.log* (domain log)
   and */var/log/sssd/sssd\_sudo.log* (sudo responder log)
...
**Fixed in 1.14.0**:
`​https://fedorahosted.org/sssd/ticket/2919 <https://fedorahosted.org/sssd/ticket/2919>`__
...
`​https://fedorahosted.org/sssd/ticket/3046 <https://fedorahosted.org/sssd/ticket/3046>`__
