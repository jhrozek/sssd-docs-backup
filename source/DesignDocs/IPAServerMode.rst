...
-  `​RFE Allow using UIDs and GIDs from AD in trust
   case <https://fedorahosted.org/sssd/ticket/1821>`__
-  `​RFE Determine how to map SID to UID/GID based on IdM server
   configuration <https://fedorahosted.org/sssd/ticket/1881>`__
-  more to come
...
(`​https://fedorahosted.org/freeipa/ticket/3567 <https://fedorahosted.org/freeipa/ticket/3567>`__)
...
server
(`​https://fedorahosted.org/freeipa/ticket/3647 <https://fedorahosted.org/freeipa/ticket/3647>`__)
...
`#1993 <https://fedorahosted.org/sssd/ticket/1993>`__) which defaults to
*false* but is set to *true* during ipa-server-install or during updates
of the FreeIPA server
(`​https://fedorahosted.org/freeipa/ticket/3652 <https://fedorahosted.org/freeipa/ticket/3652>`__)
...
(`​https://fedorahosted.org/freeipa/ticket/3651 <https://fedorahosted.org/freeipa/ticket/3651>`__,
...
#. Allow algorithmic mapping where the first RID is not 0 Currently it
   ...
   Ticket: `#1938 <https://fedorahosted.org/sssd/ticket/1938>`__
#. Add a range type to handle mappings in AD The idea is that ranges for
   ...
   Ticket: `#1960 <https://fedorahosted.org/sssd/ticket/1960>`__
...
`#1829 <https://fedorahosted.org/sssd/ticket/1829>`__ contains a similar
