Simple D-Bus API design {#SimpleD-BusAPIdesign}
=======================

Related ticket(s):

-   [[​]{.icon}Create a library to simplify usage of D-Bus
    responder](https://fedorahosted.org/sssd/ticket/2254){.ext-link}
...
-   Naming convention of D-Bus methods:
    -   **List&lt;class&gt;&lt;condition&gt;(arg1, ...)** returning
        array of object paths
        -   ListUsers()
        -   ListDomains()
        -   ListUsersByName(filter)
        -   ListGroupsByName(filter)
    -   **Find&lt;class&gt;&lt;condition&gt;(arg1, ...)** returning
        single object path
        -   FindUserById(id)
