...
-  Tickets filed:
   ...
   -  `​Arbitrary ticket
      metadata <https://pagure.io/pagure/issue/1308>`__
   -  `​Watch / follow / subscribe to
      issues <https://pagure.io/pagure/issue/1293>`__
   -  `​Adding a mailing list address to any project to receive updates
      from issues <https://pagure.io/pagure/issue/1258>`__
   -  `​Ability to be CCed in
      bugs <https://pagure.io/pagure/issue/746>`__
   -  `​pull-request/email
      integration <https://pagure.io/pagure/issue/15>`__
