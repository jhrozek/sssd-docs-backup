...
[\#2881](/sssd/ticket/2881 "MAN: Clarify that subdomains always use service discovery"){.closed}
...
[\#2959](/sssd/ticket/2959 "The delete operation of the memberof plugin allocates memory on NULL ..."){.closed}
