...
[\#2349](/sssd/ticket/2349 "public key validator is too strict and does not allow newlines anywhere in ..."){.closed}
...
[\#2402](/sssd/ticket/2402 "IFP: FQDN lookups are broken"){.closed}
